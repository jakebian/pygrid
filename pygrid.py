...
class PyGrid(object):
    KEYS = {
        latin1.XK_Z: {'name':'bottomleft',  'filter':lambda s: s.x1 == 0.0 and s.y2 == 1.0},
        latin1.XK_X: {'name':'bottom',      'filter':lambda s: s.y2 == 1.0 and _center(s.x1,s.x2)},
        latin1.XK_C: {'name':'bottomright', 'filter':lambda s: s.x2 == 1.0 and s.y2 == 1.0},
        latin1.XK_A: {'name':'left',        'filter':lambda s: s.x1 == 0.0 and _center(s.y1,s.y2)},
        latin1.XK_S: {'name':'middle',      'filter':lambda s: _center(s.x1,s.x2) and _center(s.y1,s.y2)},
        latin1.XK_D: {'name':'right',       'filter':lambda s: s.x2 == 1.0 and _center(s.y1,s.y2)},
        latin1.XK_Q: {'name':'topleft',     'filter':lambda s: s.x1 == 0.0 and s.y1 == 0.0},
        latin1.XK_W: {'name':'top',         'filter':lambda s: s.y1 == 0.0 and _center(s.x1,s.x2)},
        latin1.XK_E: {'name':'topright',    'filter':lambda s: s.x2 == 1.0 and s.y1 == 0.0},
    }
